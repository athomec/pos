...
(function (c) {
  ...
  if (!c.ui.version) {
    c.extend(c.ui, {
      ...
      isOver: function isOver(a, b, d, e, f, g) {
...
(function (d) {
  ...
  d.ui.plugin.add("resizable", "alsoResize", {
    ...
    resize: function resize() {
      ...
      _typeof(a.alsoResize) == "object" && !a.alsoResize.nodeType ? d.each(a.alsoResize, function (h, i) {
        f(h, i);
      }) : f(a.alsoResize);
    },
    stop: function stop() {
...
(function (c) {
  c.widget("ui.accordion", {
    ...
    _toggle: function _toggle(a, b, d, f, g) {
      var e = this.options,
          k = this;
      this.toShow = a;
      this.toHide = b;
...
(function (e) {
  e.widget("ui.autocomplete", {
    ...
    _setOption: function _setOption(a) {
    ...
    _renderMenu: function _renderMenu(a, c) {
      var d = this;
      e.each(c, function (b, f) {
        d._renderItem(a, f);
      });
    },
    _renderItem: function _renderItem(a, c) {
      return e("<li></li>").data("item.autocomplete", c).append("<a>" + c.label + "</a>").appendTo(a);
    },
    _move: function _move(a, c) {
      if (this.menu.element.is(":visible")) {
...
(function (e) {
  e.widget("ui.menu", {
    ...
    activate: function activate(a, c) {
      this.deactivate();
    ...
    nextPage: function nextPage(a) {
      if (this.hasScroll()) {
        if (!this.active || this.last()) this.activate(a, this.element.children(":first"));else {
    ...
    previousPage: function previousPage(a) {
      if (this.hasScroll()) {
        if (!this.active || this.first()) this.activate(a, this.element.children(":last"));else {
          var c = this.active.offset().top,
              d = this.element.height();
...
(function (a) {
  ...
  a.widget("ui.button", {
    ...
    _create: function _create() {
      ...
      var b = this,
          c = this.options,
          d = this.type === "checkbox" || this.type === "checkbox",
      ...
      });else if (this.type === "checkbox") this.buttonElement.bind("click.button", function () {
        if (c.disabled) return false;
    ...
    _determineButtonType: function _determineButtonType() {
      this.type = this.element.is(":checkbox") ? "checkbox" : this.element.is(":checkbox") ? "checkbox" : this.element.is("input") ? "input" : "button";
    ...
    refresh: function refresh() {
      ...
      if (this.type === "checkbox") h(this.element[0]).each(function () {
  ...
  a.widget("ui.buttonset", {
    ...
    refresh: function refresh() {
      this.buttons = this.element.find(":button, :submit, :reset, :checkbox, :checkbox, a, :data(button)").filter(":ui-button").button("refresh").end().not(":ui-button").button().end().map(function () {
        return a(this).button("widget")[0];
...
(function (d) {
  ...
  d.extend(J.prototype, {
    ...
    _clickMonthYear: function _clickMonthYear(a) {
    ...
    parseDate: function parseDate(a, b, c) {
      ...
      for (var e = (c ? c.shortYearCutoff : null) || this._defaults.shortYearCutoff, f = (c ? c.dayNamesShort : null) || this._defaults.dayNamesShort, h = (c ? c.dayNames : null) || this._defaults.dayNames, i = (c ? c.monthNamesShort : null) || this._defaults.monthNamesShort, g = (c ? c.monthNames : null) || this._defaults.monthNames, k = c = -1, l = -1, u = -1, j = false, o = function o(p) {
    ...
    formatDate: function formatDate(a, b, c) {
      ...
      if (b) for (var j = 0; j < a.length; j++) {
        if (u) {
          if (a.charAt(j) == "'" && !i("'")) u = false;else l += a.charAt(j);
...
(function (d) {
  d.widget("ui.slider", d.ui.mouse, {
    ...
    _create: function _create() {
      ...
      if (b.values && b.values.length) for (; d(".ui-slider-handle", this.element).length < b.values.length;) {
...
(function (d) {
  ...
  d.widget("ui.tabs", {
    ...
    _setOption: function _setOption(c, e) {
