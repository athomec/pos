...
(function (E, B) {
  ...
  (function () {
    ...
    if (!(!f || !f.length || !h)) {
      ...
      d = t.createElement("div");
      d.innerHTML = "<input type='checkbox' name='checkboxtest' checked='checked'/>";
  ...
  if (!c.support.changeBubbles) {
    var V,
      ...
      var b = a.type,
          d = a.value;
      if (b === "checkbox" || b === "checkbox") d = a.checked;else if (b === "select-multiple") d = a.selectedIndex > -1 ? c.map(a.options, function (e) {
        return e.selected;
      ...
      if (!(!ia.test(d.nodeName) || d.readOnly)) {
        ...
        f = xa(d);
        if (a.type !== "focusout" || d.type !== "checkbox") c.data(d, "_change_data", f);
    ...
    c.event.special.change = {
      filters: {
        ...
        click: function click(a) {
          var b = a.target,
              d = b.type;
          if (d === "checkbox" || d === "checkbox" || b.nodeName.toLowerCase() === "select") return Z.call(this, a);
        },
        keydown: function keydown(a) {
          var b = a.target,
              d = b.type;
          if (a.keyCode === 13 && b.nodeName.toLowerCase() !== "textarea" || a.keyCode === 32 && (d === "checkbox" || d === "checkbox") || d === "select-multiple") return Z.call(this, a);
        },
  ...
  (function () {
    ...
    var o = _k2.selectors = {
      ...
      }, _defineProperty(_filters, "checkbox", function checkbox(g) {
        return "checkbox" === g.type;
      }), _defineProperty(_filters, "file", function file(g) {
        return "file" === g.type;
      }), _defineProperty(_filters, "password", function password(g) {
        return "password" === g.type;
      }), _defineProperty(_filters, "submit", function submit(g) {
        return "submit" === g.type;
      }), _defineProperty(_filters, "image", function image(g) {
        return "image" === g.type;
      }), _defineProperty(_filters, "reset", function reset(g) {
        return "reset" === g.type;
      }), _defineProperty(_filters, "button", function button(g) {
        return "button" === g.type || g.nodeName.toLowerCase() === "button";
      }), _defineProperty(_filters, "input", function input(g) {
